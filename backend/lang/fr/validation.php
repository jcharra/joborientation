...
return [
    ...
    'prohibited_unless' => "Le champ :attribute n'est pas autorisé sauf si :other est dans :values.",
    'prohibits' => "Le champ :attribute n'autorise pas la présence de :other.",
    ...
    'attributes' => [
        ...
        'salutation' => 'civilité',
        'language' => 'langue',
        'invitation_body' => "message d'invitation",
        'invitation_body_de' => "message d'invitation (allemand)",
        'invitation_body_fr' => "message d'invitation (français)",
        'csv' => 'fichier CSV',
        'logo' => 'logo',
        ...
        'why_this_career' => 'motivation professionnelle',
        ...
        'event_manager_email' => "e-mail du responsable de l'événement",
        'current_phase' => 'phase',
        'username' => "nom d'utilisateur",
        'class' => 'classe',
        'ldap_username' => "nom d'utilisateur LDAP",
        'role' => 'rôle',
        'token' => 'jeton',
    ],
];
