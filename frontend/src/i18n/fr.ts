export default {
  ...
  admin: {
    ...
    phase: {
      ...
      preparationDesc: "Les conseillers peuvent modifier leur profil et leur session. Les étudiants peuvent se connecter mais voient un message « bientôt disponible ».",
      selection: 'Sélection',
      selectionDesc: "Les étudiants peuvent choisir et classer jusqu'à 6 tags. Les conseillers peuvent encore modifier leur profil et leur session.",
      conference: 'Conférence',
      conferenceDesc: "Les étudiants peuvent consulter leur planning. Les conseillers voient leurs créneaux et les listes de participants. Aucune modification n'est possible.",
